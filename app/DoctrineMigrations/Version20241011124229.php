 ...
 */
final class Version20241011124229 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7E0E9D4711480F96 ON nom_type (parent_name_key)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_7E0E9D4711480F96 ON nom_type');
