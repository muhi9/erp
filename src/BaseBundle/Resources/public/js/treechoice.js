...
if (undefined === formName)
  var formName = 'BaseBundle_basenoms';
var nomLevel = 0;
...
function initLoadTypes(el) {
  var el = $(el);
  if(el.val()!='') {
    var target = $('#kform_id_BaseBundle_basenoms .k-portlet__body');
      ...
      $.ajax({
        ...
        success:function(result) {
          if(result['result']!=0) {
            ...
            //$('#level_'+nomLevel).attr('name','BaseBundle_basenoms[parent]');
...
function addNameByType(nomKey, afterEl) {
  ...
  function addName(data) {
    ...
    var loadValue = '';
    var targetEl = null;
    //var elName = 'BaseBundle_basenoms[name]';
...
(function() {
 ...
 //load nom types
//  $(document).on('change', 'div.nomtree #BaseBundle_basenoms_type', function(){
//    initLoadTypes($(this));
//  });
