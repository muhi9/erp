...
function submit(e,sc) {
    ...
    $('.error').remove();
      ...
      name = $('#name').val();
      type = 'ac.variant';
      insertData = {'data':{'table':'BaseBundle:BaseNoms','value':{'parent_id':parentId,'type':type,'name':name,'status':1}}};
...
function addBaseNom(obj){
    ...
    if(newElement != null&&newElement != ''){
        ...
        //insertData = {'data':{'table':'BaseBundle:BaseNoms','value':{'parent_id':parentId,'type':objType,'name':newElement,'status':1}}};
