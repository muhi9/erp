...
class MenuBuilder{
    ...
    public function menuBuilder(){
        ...
        return $this->container->get('twig')->render('@Base/Menu/'.$this->container->getParameter('menuView').'.html.twig',['menu'=>$menuItems]);
    }
    ...
    public function breadCrumb(){
        ...
        return $this->container->get('twig')->render('@Base/Menu/breadCrumb.html.twig',$opts);
